...
# Explanability Techniques for Plant Disease Identification with Computer Vision

This project replicates and enhances the 2022 work by [Hassan & Maji](https://ieeexplore.ieee.org/document/9674894) through the addition of explanability techniques including GradCAM, LIME and SHAP. The replicated work uses a depthwise CNN built with ResNet and Modified Inception Architecture to identify plant disease across three datasets with computer vision, namely [PlantVillage](www.tensorflow.org/datasets/catalog/plant_village), [Rice Disease](https://data.mendeley.com/datasets/fwcj7stb8r/1) and [Cassava Disease](https://www.kaggle.com/competitions/cassava-disease/data).

## Features

- Model architecture built with Depthwise convolution, ResNet connections and modified Inception blocks
- Trains a CNN model across three datasets: plantvillage, rice disease and cassava disease
- Models are trained to detect 26 unqiue diseases across 5 crops: corn, potato, potato, rice and cassava
- Validate model performance with cross validation
- Explanations of local and global predictions using saliency heatmaps generated with Grad-CAM, LIME and SHAP
- Results of original work replicated within a margin of ±5% including accuracy, precision, recall and F1-score
